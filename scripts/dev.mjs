...
const server=createServer(async(req,res)=>{
  const assets={};
  for(const [file,type] of [['index.html','text/html; charset=utf-8'],['welcome.html','text/html; charset=utf-8'],['styles.css','text/css'],['app.js','text/javascript']]) assets['/'+file]={body:await readFile(file,'utf8'),type};
